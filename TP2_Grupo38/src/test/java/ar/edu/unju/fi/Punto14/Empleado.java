...
public class Empleado {
	...
	//Constructor parametrizado que permite inicializar nombre, legajo, horas trabajadas.
	public Empleado(String nombre, int legajo, int horasTrabajadas) {
		this.nombre = nombre;
		this.legajo = legajo;
		this.fecha_Ingreso = LocalDate.of(1900,1,1);
		this.horasTrabajadas = horasTrabajadas;
	}

	//Constructor parametrizado que permite inicializar nombre, fecha de ingreso, horas trabajadas.
	...
	//Constructor parametrizado que permite inicializar nombre, horas trabajadas.
	public Empleado(String nombre, LocalDate fecha_Ingreso, int horasTrabajadas) {
		super();
		this.nombre = nombre;
		this.legajo = -9999;
